      ...
      <div className="container font-sans mx-auto px-4 py-16">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg mt-4">
            We understand that this policy may be inconvenient for some
            customers, but it is necessary to ensure the quality of our
            services. We take great pride in our work, and we want to make sure
            that our customers are satisfied with the results. If you are not
            sure if our services are right for you, please contact us for more
            information.
          </p>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg">
            ...
            information will <span className="text-primary">NOT</span> be
            stored, sold, shared, rented, or leased to any third parties by{" "}
          ...
          <p className="text-lg">
            <span className="text-primary">Bettr Fitness</span> takes
            appropriate steps to ensure data privacy and security using various
            hardware and software methodologies. However, we cannot guarantee
            the security of any information disclosed online.
          </p>

          <h3 className="text-2xl font-medium mt-6 mb-2">Third-Party Links</h3>
          <p className="text-lg">
            <span className="text-primary">Bettr Fitness</span> is{" "}
            <span className="text-primary">not</span> responsible for the
            privacy policies of websites to which it links. If you provide any
            information to such third parties, different rules regarding the
            collection and use of your personal information may apply. You are
            encouraged to contact these entities directly with any questions
            about how they use the information they collect.
          </p>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg">
            ...
            policies and rules. This includes the responsibility to keep a
            record of credit card transactions and to be aware of the policies
          ...
          <p className="text-lg">
            Once payment is successfully made, a confirmation notice will be
            sent to the customer via email within 24 hours of receipt of
            payment.
          </p>
        </section>
      </div>
