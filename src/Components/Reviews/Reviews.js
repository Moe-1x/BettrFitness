      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10">
        <div className="space-y-8">
          <div className="relative  w-full max-[970px]:w-[98%] left-1/2 -translate-x-1/2 aspect-w-16 aspect-h-9">
            <iframe
              className="max-[970px]:w-[95%] relative left-1/2  w-full -translate-x-1/2 h-full rounded-[20px] max-[1023px]:min-h-[700px]  min-h-[275px]"
          ...
          <div className="relative max-[970px]:w-[98%]  w-full left-1/2 -translate-x-1/2 aspect-w-16 aspect-h-9">
            <iframe
              className="max-[970px]:w-[95%]  w-full relative left-1/2 -translate-x-1/2  h-full rounded-[20px] max-[1023px]:min-h-[700px]  min-h-[275px]"
        ...
        <div className="col-span-1 lg:col-span-2 left-1/2 -translate-x-1/2 w-full max-[970px]:w-[98%] aspect-w-16 aspect-h-9 relative">
          <iframe
            className="max-[970px]:w-[95%]  w-full relative left-1/2 -translate-x-1/2  h-full max-[1023px]:min-h-[700px]  rounded-[20px] "
            ...
            allowFullScreen
          ></iframe>
          <div className="absolute bottom-2 pl-4 pb-4 left-2 max-[1023px]:text-[16px] text-white text-[24px] font-sans font-medium">
            Ahmed Farag - US{" "}
          </div>
        </div>
      </div>
